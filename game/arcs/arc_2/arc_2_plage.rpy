...
image ilona beach determined = speaker_sprite("ilona", "images/personnages/Ilona/beach/clear_determination.png", ILONA_SIZE[0], ILONA_SIZE[1])
image ilona beach embarrassed = speaker_sprite("ilona", "images/personnages/Ilona/beach/awkward_embarrassment.png", ILONA_SIZE[0], ILONA_SIZE[1])
image ilona beach fatigue = speaker_sprite("ilona", "images/personnages/Ilona/beach/quiet_fatigue.png", ILONA_SIZE[0], ILONA_SIZE[1])
image ilona beach frustrated = speaker_sprite("ilona", "images/personnages/Ilona/beach/frustrated_restraint.png", ILONA_SIZE[0], ILONA_SIZE[1])
image ilona beach neutral = speaker_sprite("ilona", "images/personnages/Ilona/beach/neutral.png", ILONA_SIZE[0], ILONA_SIZE[1])
